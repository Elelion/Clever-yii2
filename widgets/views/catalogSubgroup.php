...
/**
 * @var CatalogSubgroup[] $catalogList
...
<?php foreach ($catalogList as $catalog): ?>
    ...
    <div class="post-item border portfolio-item no-overlay">
        <div class="post-item-wrap">
            <div class="post-image">
                <a href="<?= Url::to([$catalog->link]); ?> ">
            ...
            <div class="post-item-description">
                ...
                <a href="<?= Url::to([$catalog->link]); ?> " class="item-link">
