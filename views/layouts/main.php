...
<?php $this->beginPage() ?>
  ...
  <div class="body-inner">
    ...
    <header
        ...
        <?= Yii::$app->controller->id === 'home' && Yii::$app->controller->action->id === 'index'
            ? ''
            : 'header-font__color-gray';
        ?>">
      ...
      <div class="header-inner">
        <div class="container">
          ...
          <!--Logo-->
          <div id="logo">
            <a href="<?= Url::to(['home/index']) ?>" class = 'header__logo-link'>
                <?= Html::img("@web/images/logo/clever.png", [
                    'class' => 'header__logo-img',
                    'alt' => 'Клевер',
                    'title' => 'Логтип компании',
                ]); ?>
            </a>
          </div>
          <!--End: Logo-->
          ...
          <div id="mainMenu">
            <div class="container">
              <nav>
                <ul>
                  <li class="dropdown"><a href="<?= Url::to(['catalog/index']) ?>">Продукция</a>
                    <ul class="dropdown-menu">
                      <li><a href="<?= Url::to(['catalog/discount']); ?> ">Лови момент<span class="badge badge-warning">АКЦИЯ</span><span class="badge badge-danger">OK</span></a></li>

                      <li class="dropdown-submenu"><span class="dropdown-menu-title-only">Окна<span class="badge badge-success">ПОПУЛЯРНОЕ</span><span class="badge badge-danger">OK</span></span>
                        <ul class="dropdown-menu">
                          <li><a href="<?= Url::to(['catalog/product-window-lumen']); ?> ">Окна Lumen<span class="badge badge-danger">NEW</span></a></li>
                          <li><a href="<?= Url::to(['catalog/product-window-rehau']); ?> ">Окна Rehau</a></li>
                          <li><a href="<?= Url::to(['catalog/product-window-kbe']); ?> ">Окна KBE</a></li>
                          <li><a href="<?= Url::to(['catalog/product-window-veka']); ?> ">Окна VEKA</a></li>
                          <li><a href="<?= Url::to(['catalog/product-window-panoramic']); ?> ">Панорамные окна</a></li>

                        </ul>
                      </li>
                      <li class="dropdown-submenu"><span class="dropdown-menu-title-only">Балконы<span class="badge badge-info">INFO</span></span>
                        <ul class="dropdown-menu">
                      ...
                      <li class="dropdown-submenu"><span class="dropdown-menu-title-only">Входные группы</span>
                        <ul class="dropdown-menu">
                      ...
                      <li class="dropdown-submenu"><span class="dropdown-menu-title-only">Раздвижные системы</span>
                        <ul class="dropdown-menu">
                      ...
                      <li><a href="page-services.html">Фасадные системы</a></li>
                      <li><a href="page-our-team.html">Цельностеклянные конструкции</a></li>
                      <li><a href="page-our-clients.html">Стеклопакеты</a></li>
                      <li><a href="page-our-clients.html">Нестандартные изделия</a></li>
                      <li><a href="page-our-clients.html">Аксессуары и комплектующие</a></li>

                      <li class="dropdown-submenu"><span class="dropdown-menu-title-only">Тест<span class="badge badge-warning">тест</span></span>
                        <ul class="dropdown-menu">

                          <li><a href="page-about-basic.html">товар - 1</a></li>

                          <li class="dropdown-submenu"><span class="dropdown-menu-title-only">Товары<span class="badge badge-danger">3st menu</span></span>
                            <ul class="dropdown-menu">
                              <li><a href="page-about-basic.html">Товар - 1</a></li>
                              <li><a href="page-about-extended.html">Товар - 2</a></li>
                            </ul>
                          </li>
                  ...
                  <li><a href="<?= Url::to(['home/portfolio']) ?>">Работы</a></li>
    ...
    <footer id="footer">
            ...
            <div class="col-lg-5">
              <div class="widget">
                <div class="widget__social">
                  <a class="btn btn-xs btn-slide btn-light" href="#" data-width="124">
                      <i class="fab fa-instagram"></i>
                      <span>Instagram</span>
                  </a>
                  <a class="btn btn-xs btn-slide btn-light" href="#" data-width="120">
                    <i class="fab fa-whatsapp"></i>
                    <span> WhatsApp</span>
                  </a>
                </div>

                <div class="widget__counters">
                  <p>разместить ЯД метрику</p>
                </div>
              </div>
            </div>
            <div class="col-lg-7">
      ...
      <div class="copyright-content">
        <div class="container">
          <div class="copyright-text text-center">&copy; 2019 Группа компаний «Клевер», 2008–<?= date("Y"); ?>. Производство и установка пластиковых окон.
            <br>
            Информация, опубликованная на Сайте, носит общий характер и служит для ознакомительных целей, не является публичной офертой.</div>
        </div>
      </div>
    </footer>
    <!-- end: Footer -->
